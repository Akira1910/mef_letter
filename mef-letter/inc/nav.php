      ...
      <ul class="navbar-nav">
		...
		<?php 
			if(isset($_SESSION["usrlevel"])) 
			{
				...
				{
		?>		
				<a class="nav-link mynav" id="entry" style="color: white; border-radius:20px;" href="entry.php">User Account</a>
		<?php
				} else {
		?>
				<span class="nav-link mynav" id="entry" style="color: white; border-radius:20px;" href="entry.php">User Account</a>			
		<?php
			}
			} else {
		?>
